...
def build_debug_message(report: Dict) -> str:
    ...
    for portal in report.get('sources', []):
        lines.append(
            f"• <b>{html.escape(portal['name'])}</b>: kind={portal['kind']}, enabled={portal['enabled']}, extraídos={portal['raw_count']}, válidos={portal['valid_count']}, nuevos/cambios={portal['notify_count']}, errores={portal['error_count']}"
        )
